const addToCart = (cartArray, productId, price, old_price, quantity = 1) => {
  let isProduct = false;
...
const calcCartOldPrice = (cartArray) => {
  let total = 0;

  for (let key in cartArray) {
    total += +cartArray[key].old_price * +cartArray[key].quantity;
  }
